                    ...
                    <fieldset class="border border-slate-300 rounded-md pl-4 pr-2 pb-4 pt-2">
                        ...
                        <div class="flex flex-col mb-2">
                            ...
                            <div class="flex flex-row gap-2">
                                <select class="flex-none border border-slate-300 bg-blue-600 text-white shadow-md rounded-md text-md p-2">
                                    <option>KTP</option>
                                    <option>KTM</option>
                                </select>
                                <input type="text" class="flex-auto border border-slate-300 bg-white shadow-md rounded-md text-md p-2" placeholder="Nomor Identitas Nasabah">
                                <button class="flex-none bg-blue-700 hover:bg-blue-900 text-white pb-2 pt-2 pr-4 pl-4 rounded-md">Cari</button>
                            </div>
                        </div>

                        <div class="flex flex-col mb-2">
                            <label>Nama Nasabah</label>
                            <input class="border border-slate-300 bg-white shadow-md rounded-md text-md p-2" placeholder="Nama Nasabah (terisi otomatis)" readonly>
                        </div>

                        <div class="flex flex-col mb-2">
                            <label>Alamat Nasabah</label>
                            <textarea class="border border-slate-300 bg-white shadow-md rounded-md text-md p-2" placeholder="Nama Nasabah (terisi otomatis)" readonly></textarea>
                        </div>

                        <!-- <div class="flex flex-col">
                            <label>CIF</label>
                            <select class="border border-slate-300 bg-white shadow-md rounded-md text-md p-2" v-model="formJualBeli.kd_cif">
